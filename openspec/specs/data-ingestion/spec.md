...
Fetch fuel price data from external sources — fuel-prices.eu/llms.txt (SE/DK/FI) and SSB Statbank table 09654 (NO) — parse them into structured records, extract the ECB EUR→SEK reference rate, and normalize everything to a unified schema.
