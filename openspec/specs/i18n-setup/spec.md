...
NordicPump MUST serve content in 6 languages (sv, da, nb, fi, en, es) with route-prefixed URLs and an automatic detection chain. The architecture SHALL support future RTL languages via CSS logical properties.
