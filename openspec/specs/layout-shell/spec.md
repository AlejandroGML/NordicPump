...
NordicPump MUST render a responsive application shell with header, router-outlet, and footer. Tailwind CSS MUST be configured with the PLAN.md design tokens as theme extensions.
...
- **AND** touch targets are ≥ 44×44px per WCAG AA
