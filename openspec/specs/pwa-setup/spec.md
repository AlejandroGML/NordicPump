...
NordicPump MUST function as an installable Progressive Web App with offline-first resilience. The PWA setup covers manifest, service worker, app shell, splash screen, and install prompt UX.
